...
public class LLVMVisitor2: Visitor {
	...
	public override void Visit( AST_nonleaf node, object data ) {
        ...
        case NodeType.While:
			...
			SymTab syCopy2 = sy.Clone();
			string[] labels2 = {CS, WS, WE};
			node[0].Accept(this, labels2);
			llvm.DivertOutput();
			node[1].Accept(this,data);
			string blockCode = llvm.UndivertOutput();
			llvm.WriteLabel(CS);
			lastBBLabel = CS;
			llvm.Join("conditionalstart", syCopy2, "whilestart", sy);
        ...
        case NodeType.PlusPlus:
			...
			LLVMValue one = new LLVMValue("i32", "1", false);
			lastValueLocation = llvm.WriteIntInst(NodeType.Add, savedValue, one);
			
			SymTabEntry dest2 = lastLocalVariable;
			dest2.SSAName = lastValueLocation.LLValue;
			lastLocalVariable = null;
        ...
        case NodeType.MinusMinus:
            ...
            node[0].Accept(this,data);
			savedValue = llvm.ForceIntValue(lastValueLocation);
			LLVMValue one2 = new LLVMValue("i32", "1", false);
			lastValueLocation = llvm.WriteIntInst(NodeType.Sub, savedValue, one2);

			SymTabEntry dest = lastLocalVariable;
			dest.SSAName = lastValueLocation.LLValue;
			lastLocalVariable = null;
        ...
        case NodeType.UnaryMinus:
			...
			lastValueLocation = llvm.WriteIntInst(NodeType.Sub, zero, savedValue);
        ...
        case NodeType.And:
			...
			lastBBLabel = midlab;
			//llvm.WriteCondBranch(lastValueLocation, t, f); Oops, this was already done at If!
			break;
        case NodeType.Or:
			...
			//llvm.WriteCondBranch(lastValueLocation, t2, f2); Oops, This was already done at If! 
            break;
        default:
